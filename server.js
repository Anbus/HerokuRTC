...
var server_port = process.env.PORT || 5000; //process.env.OPENSHIFT_NODEJS_PORT || 8080; //process.env.MYNODEJS_SERVICE_PORT; //
...
server.listen(server_port, function () {
  ...
  console.log("started listening .. anbu.. port " + server_port);
});
