...
var server_port = OPENSHIFT_NODEJS_PORT || 8080; //process.env.MYNODEJS_SERVICE_PORT; //
var server_ip_address = OPENSHIFT_NODEJS_IP || '127.0.0.1'; //process.env.MYNODEJS_SERVICE_HOST; //
